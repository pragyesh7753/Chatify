...
const MobileHeader = ({ searchQuery, onSearchChange }) => (
    <div className="md:hidden bg-base-200/80 backdrop-blur-lg border-b border-base-300 px-4 py-3 sticky top-0 z-10">
        <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xl font-black font-logo bg-clip-text text-transparent bg-gradient-to-r from-primary via-secondary to-primary tracking-wider animate-gradient">
                Chatify
            </span>
        </div>
